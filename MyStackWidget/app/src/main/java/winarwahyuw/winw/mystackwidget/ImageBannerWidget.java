package winarwahyuw.winw.mystackwidget;
...
public class ImageBannerWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION="winarwahyuw.winw.MyStackWidget.TOAST_ACTION";
    public static final String EXTRA_ITEM="winarwahyuw.winw.MyStackWidget.EXTRA_ITEM";
